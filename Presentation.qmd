...
:::{.notes}
I'll drop the link to get R/RStudio in the chat [GET THIS!]
:::
...
## Parent File
  ...
  - Run child file (In a RMarkdown framework)
...
## Parent File 
  ...
  - Run child file (in a Quarto framework)
...
**Using the provided guide parent/child files:**
  ...
  - Modify the Parent file:
    + Use a dataset (e.g. iris, assessment data)
    + Create a list of 'programs' to iterate over
...
## Advanced Data Analysis
  ...
  - Once you have your base Parent/Child files, you can easily add on
